...
<body>
    <nav>
      ...
      <div class="division"><hr></div>
          <div class="doble">
            <div class="contactoklarens">
                <h3>Contactos</h3>
                <p class="pcontacto">Direccion: Cra. 7a #30A-04, Valledupar - Cesar</p>
                <p class="pcontacto">Telefono: (+57) 5 5727800</p>
                <p class="pcontacto">email: dvargas@klarens.com.co</p>
            </div>
            <div class="infocontactoklarens">
              <h3>Contactos</h3>
              <p class="pcontacto">Direccion: Cra. 7a #30A-04, Valledupar - Cesar</p>
              <p class="pcontacto">Telefono: (+57) 5 5727800</p>
              <p class="pcontacto">email: szarza@klarens.com.co</p>
          </div>
          </div>
      <div class="division-inferior"><hr></div>
      <footer>

            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Registro y consulta de legalizaciones</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-black mb-4">
                                    <div class="card-body">Viaticos del conductor</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <img src="img/tramite.png" alt="">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-black mb-4">
                                    <div class="card-body">Legalizacion</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <img src="img/legalizado.jpg" alt=""> 
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-black mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <img src="img/contabilidad.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-black mb-4">
                                    <div class="card-body">Reembolso</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <img src="img/reembolso.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
